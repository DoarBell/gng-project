...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (header) {
        ...
        <a data-i18n="layout_contact" href="../subpages/contactanos.html">Contactanos</a>
    ...
    if (footer) {
      ...
      <div class="footer-item">
        ...
        <div>
          <h3 data-i18n="layout_ofice">Oficinas</h3>
      ...
      <div class="footer-item">
        ...
        <div>
          <h3 data-i18n="layout_conmut">Conmutador</h3>
      ...
      <div class="footer-item">
        ...
        <div>
          <h3 data-i18n="layout_con">Contacto</h3>
